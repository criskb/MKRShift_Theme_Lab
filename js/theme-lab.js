...
const THEME_LAB_NODE_MODE_PRESETS = Object.freeze({
  ...
  soft_cards: Object.freeze({
    canvas: Object.freeze({
      ...
      node_shape_intensity: 1.24,
      node_title_height: 42,
      node_slot_height: 24,
      ...
      node_shadow_blur: 42,
      node_shadow_offset_y: 14,
      node_shadow_opacity: 0.52,
      node_inner_stroke_width: 0.35,
      node_header_band_height: 36,
      node_header_band_opacity: 0.12,
      connection_width: 3.2,
      link_render_mode: "spline",
      link_marker_shape: "circle",
      node_outline_width: 0.22,
      widget_outline_width: 1.2,
      group_outline_width: 1.5,
      reroute_dot_size: 13.5,
      reroute_slot_size: 6,
      render_connection_borders: true,
      render_connection_shadows: true,
      render_connection_arrows: false,
  ...
  media_cards: Object.freeze({
    canvas: Object.freeze({
      ...
      node_title_height: 48,
      node_slot_height: 25,
      node_widget_height: 31,
      node_corner_radius: 26,
      node_surface_style: "media-card",
      node_slot_style: "floating",
      node_shadow_blur: 46,
      node_shadow_offset_y: 15,
      node_shadow_opacity: 0.52,
      node_inner_stroke_width: 0.7,
      node_header_band_height: 38,
      node_header_band_opacity: 0.14,
      connection_width: 3.8,
      link_render_mode: "spline",
      link_marker_shape: "circle",
  ...
  minimal: Object.freeze({
    canvas: Object.freeze({
      node_shape_profile: "round",
      node_shape_intensity: 0.98,
      node_title_height: 29,
      node_slot_height: 19,
      node_widget_height: 20,
      node_corner_radius: 22,
      node_surface_style: "minimal-card",
      node_slot_style: "ring",
      node_shadow_blur: 14,
      node_shadow_offset_y: 6,
      node_shadow_opacity: 0.14,
      node_inner_stroke_width: 0.22,
      node_header_band_height: 6,
      node_header_band_opacity: 0.03,
      connection_width: 1.95,
      link_render_mode: "spline",
      link_marker_shape: "circle",
      node_outline_width: 0.1,
      widget_outline_width: 0.35,
      group_outline_width: 0.8,
      reroute_dot_size: 8,
      reroute_slot_size: 4.5,
      render_connection_borders: false,
      render_connection_shadows: false,
      render_connection_arrows: false,
    }),
    litegraph_base: Object.freeze({
      NODE_TITLE_COLOR: "#F0F2F6",
      NODE_SELECTED_TITLE_COLOR: "#FFFFFF",
      NODE_TEXT_SIZE: 13,
      NODE_TEXT_COLOR: "#D9DCE4",
      NODE_TEXT_HIGHLIGHT_COLOR: "#FFFFFF",
      NODE_SUBTEXT_SIZE: 11,
      NODE_DEFAULT_COLOR: "#1C1E24",
      NODE_DEFAULT_BGCOLOR: "#17191F",
      NODE_DEFAULT_BOXCOLOR: "#4B505C",
      NODE_DEFAULT_SHAPE: 2,
      NODE_BOX_OUTLINE_COLOR: "#7C8493",
      DEFAULT_SHADOW_COLOR: "rgba(0,0,0,0.24)",
      DEFAULT_GROUP_FONT: 22,
      WIDGET_BGCOLOR: "#13161B",
      WIDGET_OUTLINE_COLOR: "#2B313B",
      WIDGET_TEXT_COLOR: "#EEF2F7",
      WIDGET_SECONDARY_TEXT_COLOR: "#949CAA",
      LINK_COLOR: "#B6BBC7",
      EVENT_LINK_COLOR: "#A49179",
      CONNECTING_LINK_COLOR: "#F5F7FA",
      BADGE_FG_COLOR: "#F7FAFF",
      BADGE_BG_COLOR: "#242932",
    }),
    comfy_base: Object.freeze({
      "comfy-img-preview-width": "404px",
      "comfy-img-preview-height": "276px",
    }),
  }),
  ...
  glass_panels: Object.freeze({
    canvas: Object.freeze({
      ...
      node_shadow_opacity: 0.14,
      node_inner_stroke_width: 0.2,
      node_header_band_height: 30,
      node_header_band_opacity: 0.04,
      connection_width: 2.35,
      link_render_mode: "spline",
      link_marker_shape: "circle",
      node_outline_width: 0,
      widget_outline_width: 0.5,
  ...
  liquid_glass: Object.freeze({
    canvas: Object.freeze({
      ...
      node_shadow_blur: 28,
      node_shadow_offset_y: 8,
      node_shadow_opacity: 0.12,
      node_inner_stroke_width: 0.22,
      node_header_band_height: 30,
      node_header_band_opacity: 0.05,
      connection_width: 2.45,
      link_render_mode: "spline",
      link_marker_shape: "circle",
      node_outline_width: 0,
      widget_outline_width: 0.45,
...
const THEME_LAB_NODE_MODE_DESCRIPTIONS = Object.freeze({
  ...
  minimal: "Rainfrog-inspired dark rounded cards with restrained chrome, compact labels, and clean quiet ports.",
...
const THEME_LAB_NODE_SHAPE_PRESETS = Object.freeze({
  ...
  capsule: Object.freeze({
    canvas: Object.freeze({
      ...
      node_shape_intensity: 1.12,
      node_slot_style: "pill",
      node_corner_radius: 36,
      node_title_height: 37,
      node_slot_height: 22,
      node_widget_height: 24,
      node_header_band_height: 10,
      node_outline_width: 0.12,
    }),
    litegraph_base: Object.freeze({
      NODE_DEFAULT_SHAPE: 2,
    }),
